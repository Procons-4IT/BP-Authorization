                    ...
                    Case True
                        Select Case pVal.EventType
                            Case SAPbouiCOM.BoEventTypes.et_CLICK, SAPbouiCOM.BoEventTypes.et_KEY_DOWN
                                ...
                                If pVal.ItemUID = "3" And (pVal.ColUID = "3" Or pVal.ColUID = "U_Currency" Or pVal.ColUID = "U_FCalcu" Or pVal.ColUID = "U_DAmount") Then
                                    BubbleEvent = False
                                    Exit Sub
                                End If
                            Case SAPbouiCOM.BoEventTypes.et_VALIDATE
                                If pVal.ItemUID = "3" And (pVal.ColUID = "U_PDiscount") And pVal.Row > 0 Then
                                    oForm = oApplication.SBO_Application.Forms.Item(FormUID)
                                    oMatrix = oForm.Items.Item("3").Specific
                    ...
                    Case False
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_LOST_FOCUS
                                oForm = oApplication.SBO_Application.Forms.Item(FormUID)
                                oMatrix = oForm.Items.Item("3").Specific
                                If pVal.ItemUID = "3" And (pVal.ColUID = "U_PDiscount" Or pVal.ColUID = "U_PAmount") And pVal.Row > 0 Then
