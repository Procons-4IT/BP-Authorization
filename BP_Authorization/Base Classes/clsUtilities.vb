Public Class clsUtilities
    ...
    Public Function validateBP(ByVal aCode As String, ByVal aName As String, ByVal Branch As String) As Boolean
        Dim OTest As SAPbobsCOM.Recordset
        OTest = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
        If Branch = "" Then
            oApplication.Utilities.Message("Branch Details is missing...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Return False
        End If
        If aCode <> "" Then
            OTest.DoQuery("Select CardCode from OCRD where CardCode='" & aCode & "' and CardCode in (Select CardCode From CRD8 Where BPLID = '" & Branch & "')")
        ...
        If aName <> "" Then
            OTest.DoQuery("Select * from OCRD where CardName='" & aName & "' and CardCode in (Select CardCode From CRD8 Where BPLID = '" & Branch & "')")
            If OTest.RecordCount > 0 Then
                Return True
            Else
                Return False
